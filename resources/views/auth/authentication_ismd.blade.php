<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-200">
        ...
        <header class="bg-[#157D0A] flex items-center rounded border-1 w-[90%] mx-auto mt-1 mb-[20px] text-xs sm:text-base">
            <div class="flex-1 flex justify-start"><img class="ml-5 rounded-full" src="{{ asset('images/logo.jpg') }}" width="55" height="55"></div>
            ...
            <nav class="mr-5">
                <ul class="list-style-none">
                    <li><a href="{{ route('auth') }}" class="px-4 py-2 sm:px-6 sm:py-3 bg-gray-100 text-black cursor-pointer rounded-lg transition-all duration-300 ease-in-out hover:bg-green-100">Accueil</a></li>
                </ul>
            </nav>
            </div>
        </header>
        ...
        <div class="flex justify-center">
            <img id="userIcon" src="{{ asset('images/ismdIcon.png') }}" width="100" height="100" alt="Image">
        </div>
